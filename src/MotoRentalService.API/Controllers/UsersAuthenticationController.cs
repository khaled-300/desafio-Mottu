...
namespace MotoRentalService.API.Controllers
{
    ...
    public class UsersAuthenticationController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersAuthenticationController"/> class.
        /// </summary>
        ...
        public UsersAuthenticationController(IMediator mediator, ILogger<UsersAuthenticationController> logger)
        {
            _mediator = mediator;
            _logger = logger;
        }
